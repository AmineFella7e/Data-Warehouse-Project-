...
Script Purpose:
    ...
    completeness, and standardization across the 'silver' layer.
    ...
    It includes checks for:
        ...
        - Invalid or inconsistent numerical values.
        - Data consistency between related fields.
        - Referential integrity between related tables.

Usage Notes:
    - Run these checks after loading the Silver layer.
    - The expected result for validation checks is generally "No Results".
...
-- Check for Invalid Raw Dates in Bronze
-- Expectation: No Results
-- This check validates the raw YYYYMMDD integer values before conversion.
SELECT
    sls_due_dt
...
-- Expectation: No Results for mandatory dates
SELECT
    sls_ord_num,
    sls_order_dt,
    sls_ship_dt,
...
-- Check for Sales with Unknown Products
-- Expectation: No Results
SELECT
    s.sls_prd_key
...
-- Check for Sales with Unknown Customers
-- Expectation: No Results
SELECT
    s.sls_cust_id
FROM silver.crm_sales_details AS s
...
-- Data Standardization & Consistency
-- Expectation: Only standardized country names
SELECT DISTINCT
    cntry
...
-- Check for Products with Unknown Categories
-- Expectation: No Results
SELECT
    p.cat_id
